    ...
    create or replace table `project-b8fc8724-8adc-4499-9a4`.`ANALYTICS`.`mart_channel_roas_compared`
    ...
    OPTIONS(
      description="""Side-by-side comparison of all 5 models with cost and ROAS"""
    )
    as (
